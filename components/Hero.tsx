  ...
  return (
    <section className="flex flex-col h-screen items-center justify-center">
      <div className="flex flex-col justify-center  items-center space-y-2">
        ...
        <p>Seguí y calculá el rendimiento que genera <a className="font-semibold text-gray-400 hover:text-gray-300 transition-all" href="https://www.mercadopago.com.ar/cuenta" target="_blank">Mercado Pago</a> día a día</p>
